...
import { ActionHandler, ActionHandlerImpl } from "worker/action/action-handler";
import { DiscardAction } from "worker/action/actions/discard-action";
import { DungeonAction } from "worker/action/actions/dungeon-action";
import { InspectAction } from "worker/action/actions/inspect-action";
import { InventoryAction } from "worker/action/actions/inventory-action";
import { LookAction } from "worker/action/actions/look-action";
import { MessageAction } from "worker/action/actions/message-action";
import { MoveAction } from "worker/action/actions/move-action";
import { PickupAction } from "worker/action/actions/pickup-action";
import { PrivateMessageAction } from "worker/action/actions/private-message-action";
import UnspecifiedAction from "worker/action/actions/unspecified-action";
