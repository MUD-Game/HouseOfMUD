...
function getDungeon(dungeonID: string): Dungeon {
    ...
    const TestAction: ActionElement = new ActionElementImpl("1", "essen", "gegessen", "essen aktion", [new EventImpl("addhp", 10)], ["1"])
    ...
    return new DungeonImpl(dungeonID, "TestDungeon1", "Test", "1", "1", 2, 1, [TestSpecies], [TestClass], [TestGender], [TestCharacter, TestCharacterSameRoom, TestCharacterNotSameRoom], [TestRoom,TestRoomNorth, TestRoomEast, TestRoomSouth, TestRoomWest, TestRoomNorthNorth], ["abc"], [TestAction], [TestItem], [TestNpc])
}
